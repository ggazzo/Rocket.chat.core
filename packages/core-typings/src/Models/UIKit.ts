...
export type UIKitInteractionType =
...
export type UIKitUserInteractionResult =
  | UIKitUserInteractionResultError
  | UIKitUserInteraction;
...
): result is UIKitUserInteractionResultError =>
